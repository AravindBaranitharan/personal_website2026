    ...
    <section className="section-reveal section-delay-2 relative -skew-y-2 overflow-hidden border-y-2 border-black bg-black py-8 sm:py-10">
      <div className="skew-y-2 space-y-2">
        <div className="marquee">
          <div className="marquee-track font-display-upper text-[clamp(2rem,8vw,10rem)] leading-[0.86] text-[#FF4D00]">
        ...
        <div className="marquee">
          <div className="marquee-track marquee-track--reverse font-display-upper text-[clamp(2rem,8vw,10rem)] leading-[0.86] text-white">
